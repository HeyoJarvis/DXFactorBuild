...
/**
 * Merge duplicate user accounts (FIXED ORDER)
 * - First: Reassign tasks from avi@videofusion.io to avi@heyjarvis.ai
 * - Second: Delete the duplicate avi@videofusion.io account
 * - Third: Update avi@heyjarvis.ai with the correct Slack ID (U09G4EL2CHM)
 */
...
async function mergeUserAccounts() {
  console.log('🔧 Merging user accounts (FIXED ORDER)...\n');
  ...
  console.log('  Slack ID:', videofusionAccount.slack_user_id, '← This is the CORRECT Slack ID!');
  console.log('  Supabase ID:', videofusionAccount.id);
  console.log('');

  // Step 2: Reassign any tasks from videofusion account to heyjarvis account
  console.log('🔄 Step 1: Reassigning tasks from avi@videofusion.io to avi@heyjarvis.ai...');
  ...
  // Step 3: Delete the duplicate videofusion account (this frees up the Slack ID)
  console.log('🗑️ Step 2: Deleting duplicate avi@videofusion.io account...');
  ...
  console.log('✅ Deleted avi@videofusion.io account (Slack ID U09G4EL2CHM is now free)\n');

  // Step 4: NOW update avi@heyjarvis.ai with the correct Slack ID
  console.log('🔄 Step 3: Updating avi@heyjarvis.ai with correct Slack ID (U09G4EL2CHM)...');
