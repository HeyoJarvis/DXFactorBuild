        ...
        {loading ? (
          ...
          <div className="calendar-content">
            <div className="content-header">
              <h4>This Week</h4>
              <span className="item-count">{events.length} events</span>
            </div>
                ...
                events.map((event, index) => (
                  <div key={index} className="event-card-modern">
                    <div className="event-time-indicator">
                      <div className="event-time-dot"></div>
                      <div className="event-time-text">{formatEventTime(event)}</div>
                    </div>
                    <div className="event-details">
                      <div className="event-title-modern">{event.subject || event.summary}</div>
                      {event.location && (
                        <div className="event-location-modern">
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <div className="event-source-badge">
                        {event.source === 'microsoft' ? 'Outlook' : 'Google'}
                      </div>
                    </div>
                  </div>
                ))
