-- Migration: Create fresh app_teams table
-- New clean table for teams feature without legacy issues

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Drop old tables if you want a completely clean start (OPTIONAL - uncomment if needed)
...
-- Add team_id to existing tables (use new app_teams reference)
DO $$ 
BEGIN
